...
{
	core::FlowField BilateralFlowFilter::filter(const core::FlowField & flow, const ReliabilityMap & map, std::unique_ptr<kdtree::KDTreeData>& tree, const core::ImageRGB templateImage)
	{
