...
class FlowFieldHelperTest:
    def read_flow_field(self):
        flow_field = read_flow_field(r"H:\dev\opticalFlow\Prototyp\Version 2\resources\eval-twoframes-groundtruth\Dimetrodon\flow10.flo")
        ...
        flow_field2 = read_flow_field(
            r"H:\dev\opticalFlow\Prototyp\Version 2\resources\eval-twoframes-groundtruth\Grove2\flow10.flo")
