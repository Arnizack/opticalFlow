...
def diags_convolution3x3(kernel,width,height,padding ="zero"):
    """
    Creates the diagonals, from which an diagonal Matrix A can be construced.
    The matrix multiplication Ax is the same as the convolution on an image. x is the image in 1D shape with row major order
